...
my.set_volume = sdk.find_type_definition("app.Option"):get_method("SetOptionValue(app.Option.ValueType, System.Int32, System.Boolean)"):call
...
re.on_frame(function()
    ...
    if not my.was_button_down and is_down then
        ...
        my.set_volume(nil, my.TYPE_BGM_VOLUME, my.current_bgm_volume, false)
    end
